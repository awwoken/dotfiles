...
TreesitterConfigs.setup({
  ...
  ensure_installed = {
    ...
    "html", "css", "rust", "javascript", "typescript", "tsx", "vue", "json", "graphql"
  },
	highlight = {
...
MasonToolInstaller.setup({
  ...
  ensure_installed = {
    ...
    "lua-language-server", "json-lsp", "shfmt", "clangd", "eslint-lsp"
  },
	auto_update = true,
})
...
-- stylua: ignore
vim.lsp.enable({
	"lua_ls", "ts_ls", "tailwindcss", "cssls", "html", "jsonls", "clangd"
})
...
vim.api.nvim_create_autocmd("LspAttach", {
  callback = function(args)
    extraMap("gd", function() MiniExtra.pickers.lsp({ scope = "definition" }) end, args.buf)
    extraMap("gr", function() MiniExtra.pickers.lsp({ scope = "references" }) end, args.buf)
    extraMap("gt", function() MiniExtra.pickers.lsp({ scope = "type_definition" }) end, args.buf)
  end,
